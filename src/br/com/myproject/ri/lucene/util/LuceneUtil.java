package br.com.myproject.ri.lucene.util;
...
import br.com.myproject.ri.pln.util.StringUtil;
import br.edu.doc.analisador.extractor.Extractor;
import br.edu.doc.analisador.util.QuestionTopic;
...
public class LuceneUtil {
	...
	public static final String[] BRAZILIAN_STOP_WORDS = {"a", "agora", "ainda", "alguEm", "algum", "alguma", "algumas", "alguns", "ampla", "amplas", "amplo", "amplos", "ante", 
		...
		"esta", "esta", "estamos", "estão", "estas", "estava", "estavam", "estávamos", "este", "estes", "estou", "eu", "fazendo", "fazer", 
		"feita", "feitas", "feito", "feitos", "foi", "for", "foram", "fosse", "fossem", "grande", "grandes", "há", "isso", "isto", "já", 
		"la", "la", "lhe", "lhes", "lo", "mas", "me", "mesma", "mesmas", "mesmo", "mesmos", "meu", "meus", "minha", "minhas", 
		"muita", "muitas", "muito", "muitos", "na", "não", "nas", "nem", "nenhum", "nessa", "nessas", "nesta", "nestas", "ninguem", 
		...
		"pode", "podendo", "poder", "poderia", "poderiam", "podia", "podiam", "pois", "por", "porém", "porque", "posso", "pouca", 
		"poucas", "pouco", "poucos", "primeiro", "primeiros", "própria", "proprias", "proprio", "proprios", "quais", "qual", "quando", 
		...
		"ata", "atrvés", "avia", "aw", "aww", "axar", "axo", "babak", "balear", "baleiar", "bastant", "baxo", 
		"baxtante", "bcta", "bgd", "bjs", "blz", "blza", "bm", "bns", "bora", "boralá", "brinks", "brow", 
		...
		"d+", "da", "daqelas", "daqele", "daqeles", "dbaxo", "debaxo", "dec", "detras", "detrás", "dik", 
		"diz", "dmais", "dntro", "dpois", "dps", "ds", "dsc", "dxar", "eh", "end", "enqnto", "enqto", 
		"entaum", "eqipe", "esqec", "et", "ex", "exmplo", "extiveram", "fas", "fazr", "fazê", 
		...
		"hovesse", "hovessem", "hovessemos", "hr", "hrs", "huahua", "i", "img", "inda", "inté", "ja", "jnto", 
		...
		"primeros", "pta", "putz", "pô", "q", "qais", "qd", "qdo", "qerem", "qeres", "qero", "qlqer", 
		"qlqr", "qm", "qnd", "qndo", "qnto", "qntos", "qq", "qr", "qrem", "qro", "qse", "qstao", "qstão", 
	...
	public static void main(String[] args) {
		...
		String input = "Precisão preciso precisa preço precisou";
		System.out.println(Extractor.vector(StringUtil.removerNaoLetras(StringUtil.removerAcentos(input))));
		System.out.println(QuestionTopic.TECHNOLOGY.getVector());

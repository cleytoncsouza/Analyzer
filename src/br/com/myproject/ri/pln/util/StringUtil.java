package br.com.myproject.ri.pln.util;
...
public class StringUtil {  
	...
	public static String onlyText(String text){
		...
		//remove os números que restaram
	...
	public static void main(String[] args) {
		String teste = "@cl3yton  vai para a #escola? acesse http://wwww.ink.com.br/algumacoisa @pessoa";
		String s = teste;
		String s1 = s.replaceAll("(https?|ftp|file)://([\\w+?\\.\\w+])+([a-zA-Z0-9\\~\\!\\@\\#\\$\\%\\^\\&amp;\\*\\(\\)_\\-\\=\\+\\\\\\/\\?\\.\\:\\;\\'\\,]*)?","");
		String s2 = s1.replaceAll("@[a-zA-Z0-9]+", "");
		String s3 = s2.replaceAll("#[a-zA-Z0-9]+", "");
		System.out.println(s3);
//		System.out.println(teste.replaceAll("(https?|ftp|file)://([\\w+?\\.\\w+])+([a-zA-Z0-9\\~\\!\\@\\#\\$\\%\\^\\&amp;\\*\\(\\)_\\-\\=\\+\\\\\\/\\?\\.\\:\\;\\'\\,]*)?", ""));//remove url
		System.out.println(teste.replaceAll("@[a-zA-Z0-9]*", ""));//remove screenaname
		System.out.println(teste.replaceAll("#[a-zA-Z0-9]*", ""));//remove hashtag
